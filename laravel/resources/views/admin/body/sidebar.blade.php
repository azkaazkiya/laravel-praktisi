<aside class="main-sidebar">
    ...
    <section class="sidebar">	
				 ...
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">					 	
						  <img src="backend/images/logo-poliwangi.png" alt="">
						  <h3>POLIWANGI</h3>
					 </div>
				</a>
			</div>
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          <a href="#">
            <i data-feather="mail"></i> <span>Kelola Mahasiswa</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('user.view')}}"><i class="ti-more"></i>Tampilkan Mahasiswa</a></li>
            <li><a href="{{route('user.add')}}"><i class="ti-more"></i>Tampilkan Mahasiswa</a></li>
          </ul>
        </li>
